...
{
    /// <summary>
    /// Specialized list implementation that provides data virtualization. The collection is divided
    /// up into pages, and pages are dynamically fetched from the IItemsProvider when required.
    /// Stale pages are removed after a configurable period of time. Intended for use with large
    /// collections on a network or disk resource that cannot be instantiated locally due to memory
    /// consumption or fetch latency.
    /// </summary>
    /// <remarks>
    /// The IList implmentation is not fully complete, but should be sufficient for use as read only
    /// collection data bound to a suitable ItemsControl.
    /// </remarks>
    ...
    public class VirtualizingCollection<T> : IList<T>, IList
    {
        ...
        /// cref="T:System.Collections.Generic.ICollection`1"/> . The first time this property is
        /// accessed, it will fetch the count from the IItemsProvider.
        /// </summary>
        /// <value></value>
        /// <returns>
        ...
        /// <summary>
        /// Gets the item at the specified index. This property will fetch the corresponding page
        /// from the IItemsProvider if required.
        /// </summary>
        /// <value></value>
        ...
        /// - or- <paramref name="arrayIndex"/> is equal to or greater than the length of <paramref
        ///   name="array"/> .
        /// - or- The number of elements in the source <see
        /// cref="T:System.Collections.Generic.ICollection`1"/> is greater than the available space
        /// from <paramref name="arrayIndex"/> to the end of the destination <paramref
        /// name="array"/> .
        /// - or- Type <paramref name="T"/> cannot be cast automatically to the type of the
        ...
        /// </summary>
        /// <remarks>This method should be avoided on large collections due to poor performance.</remarks>
        /// <returns>
